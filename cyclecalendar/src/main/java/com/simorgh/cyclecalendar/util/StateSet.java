...
public class StateSet {
    ...
    static final int[] ViewDrawableStates = new int[]{
    ...
    static {
        ...
        final int n = VIEW_STATE_IDS.length / 2;//com.android.internal.R.styleable.ViewDrawableStates.length;

        final int[] orderedIds = new int[VIEW_STATE_IDS.length];
        for (int i = 0; i < n; i++) {
            final int viewState = ViewDrawableStates[i]; //com.android.internal.R.styleable.ViewDrawableStates[i]; // TODO alternative ViewDrawableStates[i];
